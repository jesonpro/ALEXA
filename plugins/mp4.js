...
const NO_RESULT = "*🌀can't Find Anything...*"
    ...
    amazone.addCommand({ pattern: 'video ?(.*)', fromMe: tk, desc: Lang.MP4,  deleteCommand: false}, async (message, match) => {
    ...
    amazone.addCommand({ pattern: 'video ?(.*)', fromMe: true, dontAdCommandList: true}, async (message, match) => {
