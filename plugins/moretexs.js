...
Amazone.addCommand({pattern: 'metalic ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Amazone.addCommand({pattern: '3cup ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
